const TAILWIND_MAP = {
    ...
    flexDirection: {
        ...
        'col lg:flex-row': 'flex-col lg:flex-row',
        'col-reverse lg:flex-row-reverse': 'flex-col-reverse lg:flex-row-reverse',
        'col lg:flex-row-reverse': 'flex-col lg:flex-row-reverse',
        'col-reverse lg:flex-row': 'flex-col-reverse lg:flex-row',
        'col-reverse lg:flex-col': 'flex-col-reverse lg:flex-col'
    }
};
