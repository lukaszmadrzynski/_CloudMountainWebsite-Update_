...
export default function FeaturedItemsSectionShowMore(props) {
    const { elementId, colors, backgroundImage, badge, title, subtitle, text, items = [], actions = [], variant, styles = {}, enableAnnotations, showMoreLabel, showLessLabel } = props;
                ...
                {hasMoreItems && (
                    <div className="mt-8 w-full flex justify-center">
                        <button
                            ...
                            className={classNames(
                                'flex items-center px-6 py-2 rounded-full border-2 border-[#5ebb46]',
                                'transition-all duration-300 font-medium',
                                showAll 
                                    ? 'text-[#5ebb46] hover:bg-[#5ebb46]/10' 
                                    : 'bg-[#5ebb46] text-white hover:bg-[#5ebb46]/90'
                            )}
                        >
                            <span>{showAll ? (showLessLabel || 'Show Less Highlights') : (showMoreLabel || 'Show All Highlights')}</span>
                        </button>
                    </div>
                )}
